@extends('app')
@section('title', Config('app.name') . ' |' . ' Services 4')
        ...
        <section>
            <div class="page-heading header-text">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1>Management de l’innovation et
                                diversification des services</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="left-content">
                                <h4>Management de l’innovation et
                                    diversification des services</h4>
